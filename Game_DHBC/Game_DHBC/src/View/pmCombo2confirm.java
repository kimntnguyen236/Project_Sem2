 ...
 * @author BuuBuu
 */
public class pmCombo2confirm extends javax.swing.JFrame implements ActionListener {

    ArrayList<GamePlayInfo> gameinfo;

    public pmCombo2confirm() {
        initComponents();
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        for (GamePlayInfo item : gameinfo) {
            if (item.getPlayerID().equals("a")) {
                ...
                name = item.PlayerID;
                GamePlayInfoDAO.updateGem(gem + 70, name);
                JOptionPane.showMessageDialog(this, "Tài Khoản của bạn đã được nạp 70 Gem thành công.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pmCombo2confirm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pmCombo2confirm().setVisible(true);
            }
        });
    }
