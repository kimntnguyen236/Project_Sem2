 ...
 * @author BuuBuu
 */
public class pmCombo4confirm extends javax.swing.JFrame implements ActionListener {

     ArrayList<GamePlayInfo> gameinfo;
    public pmCombo4confirm() {
        initComponents();
       ...
       gameinfo = new GamePlayInfoDAO().getList();
        ...
        for (GamePlayInfo item : gameinfo) {
            if (item.getPlayerID().equals("a")) {
                ...
                name = item.PlayerID;
                GamePlayInfoDAO.updateGem(gem + 300, name);
                JOptionPane.showMessageDialog(this, "Tài Khoản của bạn đã được nạp 300 Gem thành công.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pmCombo4confirm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pmCombo4confirm().setVisible(true);
            }
        });
    }
