...
//        JLabel imgProfile = new JLabel();
        ...
        txtName.setBounds(90, 30, 180, 29);
        ...
        Answer.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                if (s1.equals(danan)) {
                    ...
                    DIEM += 40;
                    MANCHOI += 1;
                    numDiem.setText(String.valueOf(DIEM));
                    numGem.setText(String.valueOf(KIMCUONG));
                    numScen.setText(String.valueOf(MANCHOI));
                    PlayerInfoDAO.updateGemScoreScen(KIMCUONG, DIEM, MANCHOI, txt);
                } else {
                    ...
                    if (KIMCUONG >= 5) {
                        while (true) {
                            ...
                            if (danan.length() == checkGY) {
                                JOptionPane.showMessageDialog(null, "Không có ô trống để sử dụng gợi ý");
                                return;
                            }
                        ...
                        JOptionPane.showMessageDialog(null, "Bạn không đủ kim cương để sử dụng gợi ý");
                        return;
                    }
                }
                PlayerInfoDAO.updateGem(DIEM, txt);
            }
        });
    }
