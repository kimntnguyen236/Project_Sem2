...
create table Players(
	...
	PlayerAvatar varchar(100) default './src/Avatars/avata30.jpg',
)
go
...
create table GamePlayInfo(
	...
	quesId int references QA(quesId) not null default(1),
...
go
select CardID, Seri, Card_value, Gem
from Store
...
drop table QA
 ...
 insert QA(quesContent,ansContent) values
('./src/QAImages/9Thang10Ngay.JPG','CHINTHANGMUOINGAY'),
('./src/QAImages/an-may.png','ANMAY'),
('./src/QAImages/BunBoGioHeo.JPG','BUNBOGIOHEO'),
('./src/QAImages/CaoChayXaBay.JPG','CAOCHAYXABAY'),
('./src/QAImages/tranhsondau.jpg','TRANHSONDAU'),
('./src/QAImages/nambancau.png','NAMBANCAU'),
('./src/QAImages/lan-toa-niem-vui.png','LANTOAMNIEMVUI')
...
insert into GamePlayInfo(PlayerID,quesId,PlayerGem,PlayerScore)
values
('ThanhAn123',4,100,10),('Thien123',6,200,20)
...
insert into Admins(AdID,AdPassword,AdEmail,AdDOB,AdPhone)
values
('Admin','qwertasdfgzxcvb','Admin@gmail.com','2001-06-23','0123456789')